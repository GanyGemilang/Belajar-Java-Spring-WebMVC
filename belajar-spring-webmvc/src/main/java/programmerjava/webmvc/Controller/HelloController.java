...
import programmerjava.webmvc.Service.HelloService;
...
public class HelloController {
    ...
    public void HelloWord(@RequestParam(name="name", required = false) String name, HttpServletResponse response) throws IOException {
